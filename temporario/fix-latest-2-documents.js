...
async function fixLatest2Documents() {
    console.log('🔄 Recuperando los 2 documentos más recientes...');
    ...
    try {
        // Obtener los 2 documentos más recientes
        ...
        for (const document of documents) {
            console.log(`\n📄 Procesando documento: ${document.filename}`);
