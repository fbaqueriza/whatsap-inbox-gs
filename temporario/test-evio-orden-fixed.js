// Script para probar el template evio_orden sin variables
const testEvioOrden = async () => {
  try {
    console.log('🔍 Probando template evio_orden sin variables...');
    ...
    if (result.success) {
      ...
      if (result.content.includes('NUEVA ORDEN') && result.content.includes('Buen día')) {
