...
export async function GET(request: NextRequest) {
  try {
    console.log('🚀 [AutoWebhook] Configurando webhook automáticamente...');
    ...
    console.log('🔧 [AutoWebhook] Configurando webhook en Kapso:', {
      kapsoConfigId,
      webhookUrl,
    ...
    console.log('📊 [AutoWebhook] Respuesta de Kapso:', {
