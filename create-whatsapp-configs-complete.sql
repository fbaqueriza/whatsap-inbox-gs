-- ============================================
-- 📱 CREAR TABLA whatsapp_configs COMPLETA
-- ============================================
...
-- Crear política RLS (permite que service role ignore RLS)
...
COMMENT ON COLUMN whatsapp_configs.phone_number IS 'Número de teléfono de WhatsApp';
COMMENT ON COLUMN whatsapp_configs.kapso_config_id IS 'ID de la configuración en Kapso Platform';
COMMENT ON COLUMN whatsapp_configs.is_active IS 'Indica si esta configuración está activa';
