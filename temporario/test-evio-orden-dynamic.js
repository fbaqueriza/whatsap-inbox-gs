...
async function testEvioOrdenDynamic() {
  console.log('🧪 Verificando template evio_orden con componentes dinámicos...');

  // Test: Template evio_orden con variables dinámicas
  try {
    console.log('\n📤 Enviando template evio_orden con variables dinámicas...');
